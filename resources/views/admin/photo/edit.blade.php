                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="1" {{ $photo->is_active === '1' ? 'selected' : '' }}>
                                                Aktif
                                            </option>
                                            <option value="0" {{ $photo->is_active === '0' ? 'selected' : '' }}>
                                                Tidak Aktif </option>
                                        </select>
                                        @error('is_active')
                                            <div class="invalid-feedback" style="display: block">
                                        ...
                                        <select
                                            ...
                                            @foreach ($galeris as $galeri)
                                                @if ($photo->galeri_id == $galeri->id)
                                                    <option value="{{ $galeri->id }}" selected>{{ $galeri->title }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" placeholder="Masukkan Judul photo"
                                            value="{{ old('title', $photo->title) }}" class="form-control">
                                        @error('title')
                                            <div class="invalid-feedback" style="display: block">
                                                {{ $message }}
                                            </div>
