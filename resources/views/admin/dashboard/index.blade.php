...
@section('content')
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ App\Models\Galeri::count() ?? '0' }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ App\Models\Slider::count() ?? '0' }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                ...
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Sebaran Jumlah Pegawai ASN KLHK per tanggal 23 Sept 2022 (contoh ya!)</h3>
                    ...
                    <div class="card-body">
                        <div class="chart">
                            <canvas id="stackedBarChart" style="min-height: 250px;  max-width: 100%;"></canvas>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
    ...
    <script>
        $(function() {
            ...
            //---------------------
            var areaChartData = {
                labels: <?php echo str_replace('&quot;', "'", json_encode($eselonasns)); ?>,
                datasets: [{
                        label: 'PNS {{ App\Models\Jumlahasn::count() ?? '0' }}',
                        ...
                        data: {{ str_replace('', ',', json_encode($jumlahasns)) }}
                    },
                    {
                        label: 'PPNPN',
                        ...
                        data: {{ str_replace('', ',', json_encode($jumlahppnpns)) }}
                    },
                ]
            }
