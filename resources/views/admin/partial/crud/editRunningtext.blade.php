        ...
        <div class="row">
          <div class="col-12">
            <div class="card mt-4">
              ...
              <form action="{{ url('/editRuntext')}}/{{$runtext->id}}/edit" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="judul">Isi Running Text</label>
                    <textarea id="isiText" class="form-control" rows="1" name="isiText" >{{ $runtext->isiText }}</textarea>
                  </div>
                </div>
