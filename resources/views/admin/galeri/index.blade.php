                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ route('admin.galeri.index') }}" method="GET">
                                            ...
                                            @foreach ($galeris as $no => $galeri)
                                                <tr>
                                                    <th scope="row" style="text-align: center">
                                                        {{ ++$no + ($galeris->currentPage() - 1) * $galeris->perPage() }}
                                                    </th>
                                                    <td>{{ $galeri->title }}</td>
                                                    <td><img src="{{ asset($galeri->image) }}" style="width: 150px">
                                                    </td>
                                                    <td style="width: 15%;text-align: center">
                                                        @if ($galeri->is_active == '0')
