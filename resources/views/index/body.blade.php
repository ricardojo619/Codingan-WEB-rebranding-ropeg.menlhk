...
<html lang="en">
  <head>
    ...
    <title>ROPEG KEMENLHK-Biro Kepegawaian dan Organisasi Tatalaksana</title>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <h2>Pengumuman SKD CPNS 2021</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eu fringilla lacus. Morbi rhoncus magna non ipsum posuere lacinia. Etiam metus sapien, mollis vel venenatis eu, ornare sed dui.</p>
        <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        ...
        <h2>Sosialisasi SIMPEG & MySAPK 2021</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eu fringilla lacus. Morbi rhoncus magna non ipsum posuere lacinia. Etiam metus sapien, mollis vel venenatis eu, ornare sed dui.</p>
        <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
  ...
  <div class="page-wrapper">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">Statistik PNS</div>
        <div class="col-md-4">
          <div class="text-center">
          <h5>Struktur Organisasi</h5>
        </div> <div class="text-center"> <a href="#" class="btn btn-danger mb-4 mt-2 justify-content-center">Struktur Organisasi</a></div>
      </div>
        <div class="col-md-4">Statistik Pengunjung</div>
      </div>
    </div>
  </div>
