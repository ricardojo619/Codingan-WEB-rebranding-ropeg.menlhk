      ...
      <div class="col-9">
        <nav class="">
          <ol class="breadcrumb" style="padding: 10px 0 10px 0;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Seleksi Terbuka Pengisian JPT di Lingkungan Sekretariat Jendral DPR RI</li>
          </ol>
        </nav>
        <p class="text-capitalize fs-2 fw-bold">Seleksi Terbuka Pengisian JPT di Lingkungan Sekretariat Jendral DPR RI</p>
