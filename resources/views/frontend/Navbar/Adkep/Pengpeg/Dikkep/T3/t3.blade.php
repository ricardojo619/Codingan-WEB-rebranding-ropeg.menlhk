      ...
      <div class="col-9">
        <nav class="">
          <ol class="breadcrumb" style="padding: 10px 0 10px 0;">
            ...
            <li class="breadcrumb-item" style="padding-left: 15px;">Diklat Kepemimpinan</a></li>
            <li class="breadcrumb-item active" aria-current="page">Diklat Kepemimpinan Tingkat III</li>
          </ol>
        </nav>
        <p class="text-capitalize fs-2 fw-bold">Diklat Kepemimpinan Tingkat III</p>
        <p class=" fs-6" style="color: #a0a0a0b3;">2 juli 2022, Dilihat 233 Kali</p>
        <img src="{{ asset('img/diklat3.png') }}" class='mb-4'>
