      ...
      <div class="col-9">
        <nav class="">
          <ol class="breadcrumb" style="padding: 10px 0 10px 0;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Alih Tugas Lingkungan KLHK</li>
          </ol>
        </nav>
        <p class="text-capitalize fs-2 fw-bold">Alih Tugas Lingkungan KLHK</p>
        <p class=" fs-6" style="color: #a0a0a0b3;">2 juli 2022,  Dilihat 233 Kali</p>
        <img src="{{ asset('img/alihtugaslingkupklhk.png') }}" class='mb-4'>
