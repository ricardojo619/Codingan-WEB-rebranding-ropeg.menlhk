...
<div class="container">
    <div class="row">
      ...
      <div class="col-9">
        ...
        <p class="text-capitalize fs-2 fw-bold">Struktur Organisasi Biro Kepegawaian dan Organisasi Kementerian Lingkungan Hidup dan Kehutanan</p>
        <p class="fw-lighter fs-6" style="color: #a0a0a0b3;">2 juli 2022, Dilihat 233 Kali</p>
        <img src="{{ asset('img/strukturorg.png') }}" class="img-thumbnail"alt="">
      </div>
      <div class="col-3">
