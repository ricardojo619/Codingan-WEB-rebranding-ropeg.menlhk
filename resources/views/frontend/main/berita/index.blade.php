    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-3">
                ...
                @foreach ($listinfolain as $baca)
                    <div class="card mb-3" style="max-width: 540px;border:1px solid #fff">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="img-fluid rounded-start" src="{{ asset($baca->image) }}"
                                    alt="{{ $baca->title }}">
                            </div>
                            <div class="col-md-8">
                ...
                <hr class="mx-left" width="40%"
                    style="height: 3px;margin: 0 0 15px 0; color: #000; background-color: #000;">
                @foreach ($listpengumuman as $baca)
                    <div class="card mb-3" style="max-width: 540px;border:1px solid #fff">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="img-fluid rounded-start" src="{{ asset($baca->image) }}"
        ...
        <div class="col-9">
            ...
            <div class="social-buttons">
                ...
                <a href="#" class="social-buttons__button social-button social-button--envelope"
                    aria-label="envelope">
                    <i class="fa fa-envelope-o"></i>
                </a>
                <a href="#" class="social-buttons__button social-button social-button--whatsapp"
                    aria-label="whatsapp">
