                ...
                <div class="">
                    <h5 style="margin-left: 160px;">
                        ...
                        <a class="btn bg-darkku text-white mt-3 text-uppercase round text-center"
                            style="margin-left: -17.5px;" href="/beranda/struktur">
                            Struktur Organisasi
            ...
            <div class="col-md-4">
                <div class="text-center">
                    ...
                    <table style="width:60%" class="mt-3">
                        ...
                        <tr>
                            <td style="text-align: left;padding-left: 90px"><i class="fa-regular fa-user"></i>&nbsp; Kemarin
                            </td>
                            <td>:</td>
                            <td style="text-align: right;padding-right: 20px">110</td>
                        </tr>
                        ...
                        <tr>
                            <td style="text-align: left;padding-left: 90px"><i class="fa-regular fa-calendar"></i></i>&nbsp;
                                Tahun Ini</td>
                            <td>:</td>
                            <td style="text-align: right;padding-right: 20px">110</td>
                        </tr>
