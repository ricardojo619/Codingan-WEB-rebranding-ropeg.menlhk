      ...
      <div class="col-9">
        <nav class="">
          <ol class="breadcrumb" style="padding: 10px 0 10px 0;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Bimbingan Teknis Pengelola Adm</li>
          </ol>
        </nav>
        <p class="text-capitalize fs-2 fw-bold">Bimbingan Teknis Pengelola Adm</p>
